...
from xetra.common.Custom_exceptions import WrongMetaFileException, WrongFormatException
...
class TestS3BucketConnectorMethods(unittest.TestCase):
    ...
    def test_update_meta_file_meta_file_wrong(self):
        ...
        """
        # Expected results
        date_list_old = ['2022-12-03', '2022-12-04']
        date_list_new = ['2022-12-07', '2022-12-08']
        # Test init
        meta_key = 'meta.csv'
        meta_content = (
    ...
    def test_return_date_list_empty_date_list(self):
        ...
        # self.assertEqual(min_date_exp, min_date_return.strftime('%Y-%m-%d'))
        self.assertEqual(min_date_exp, min_date_return)
        # Cleanup after test
        self.s3_bucket.delete_objects(
            Delete={
